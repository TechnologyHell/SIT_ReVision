...
const ContactForm = ({ title='Get in Touch', className, onClose = false, type = false }) => {
    ...
    return (
        <div className={`${className} mt-5 flex justify-center items-center flex-col p-1 w-full place-self-center relative`} style={{ fontFamily: "Inter" }}>
            <h1 className="font-bold text-4xl mb-2" style={{ fontFamily: "Orbitron" }}>{title}</h1>
            {
                onClose &&
                <MdClose className="absolute top-1 right-5 text-2xl hover:cursor-pointer" onClick={onClose} />
            }
                    ...
                    <>
                        ...
                        <div className="mb-4">
                            <Dropdown
                                ...
                                className={`w-full ${className} border-0 border-b rounded-[0!important] shadow-[0 0 #0000!important] border-gray-500`}
                            />
                        </div>
                    </>
                }
